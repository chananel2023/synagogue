    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <motion.div
                ...
                className='max-w-md w-full bg-blue-400 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl 
                overflow-hidden'
            >
                <div className='p-8'>
                    <h2 className='text-3xl font-bold mb-6 text-center bg-gradient-to-r from-blue-500 to-blue-300 text-transparent bg-clip-text'>
                        ברוכים הבאים
                    </h2>
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <motion.button
                            className='mt-5 w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-blue-300 text-white 
